...
/// Class that uses the Face Tracking SDK to display a face mask for tracked skeletons
...
namespace P_Tracker2
{
    ...
    public partial class FaceTrackingViewer : UserControl, IDisposable
    {
        ...
        public static SkeletonFaceTracker current_faceData = null;
        public static FaceTrackFrame current_frame = null;
        //----------------------------------------------------
        ...
        {
            public static FaceTriangle[] faceTriangles;
